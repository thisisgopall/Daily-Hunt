              ...
              {articles.map((element) => {
                return (
                  <div className="col md-4" key={element.url}>
                    {/* jab v map ka use kro 1 unique key ka hona jaruri */}
                    <NewsItem
...
//     // let url =
//     //   `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=7589a3ffab814675b9169240de0337b4&page=1&pageSize=${props.pageSize}`;
//     //   this.setState({ loading: true });
//     // let data = await fetch(url);
//     // let parsedData = await data.json();
//     // console.log(parsedData);
...
//     // }&category=${
//     //   props.category
//     // }&apiKey=7589a3ffab814675b9169240de0337b4&page=${
//     //   this.state.page - 1
